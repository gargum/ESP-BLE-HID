...
| Spacemouse emulation                | *6-DOF Spacemouse emulation compatible with 3DConnextion software and firmware*           | *Includes 64 3DConnexion buttons users can include in keymaps*                                                               |
...
| Key combos                          | *Allows combos consisting of matrix positions, keycodes, or both in the same combo!*      | *Designed and tested with Tap/Hold cross-compatibility in mind*                                                              |
| Tap/Hold keys                       | *Allows the same key to have different inputs depending on whether it is tapped or held*  | *Designed and tested with Combo cross-compatibility in mind*                                                                 |
...
#define SPACEMOUSE_ENABLE true       // Enabling the Spacemouse feature enables the 6-DOF Spacemouse reporting alongside 64 3DConnexion buttons for use in keymaps.
